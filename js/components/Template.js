                    ...
                    <div class="p-4 md:p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                            ...
                            <div class="border border-gray-200 rounded-xl p-4 md:p-5 hover:shadow-md transition">
                                ...
                                <div class="space-y-2">
                                    <a href="https://docs.google.com/document/d/1ABC123/edit?usp=sharing" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-blue-600 text-white px-3 py-2 rounded-lg hover:bg-blue-700 transition font-medium text-sm">
                                        <ion-icon name="download-outline"></ion-icon>
                                        <span>Download DOCX</span>
                                    </a>
                                    <a href="https://docs.google.com/document/d/1ABC123/template/preview" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-gray-600 text-white px-3 py-2 rounded-lg hover:bg-gray-700 transition font-medium text-sm">
                            ...
                            <div class="border border-gray-200 rounded-xl p-4 md:p-5 hover:shadow-md transition">
                                ...
                                <div class="space-y-2">
                                    <a href="https://docs.google.com/document/d/1DEF456/edit?usp=sharing" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-green-600 text-white px-3 py-2 rounded-lg hover:bg-green-700 transition font-medium text-sm">
                                        <ion-icon name="download-outline"></ion-icon>
                                        <span>Download DOCX</span>
                                    </a>
                                    <a href="https://docs.google.com/document/d/1DEF456/template/preview" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-gray-600 text-white px-3 py-2 rounded-lg hover:bg-gray-700 transition font-medium text-sm">
                                        <ion-icon name="eye-outline"></ion-icon>
                                        <span>Preview Online</span>
                                    </a>
                            ...
                            <div class="border border-gray-200 rounded-xl p-4 md:p-5 hover:shadow-md transition">
                                ...
                                <div class="space-y-2">
                                    <a href="https://docs.google.com/document/d/1GHI789/edit?usp=sharing" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-purple-600 text-white px-3 py-2 rounded-lg hover:bg-purple-700 transition font-medium text-sm">
                                        <ion-icon name="download-outline"></ion-icon>
                                        <span>Download DOCX</span>
                                    </a>
                                    <a href="https://docs.google.com/document/d/1GHI789/template/preview" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-gray-600 text-white px-3 py-2 rounded-lg hover:bg-gray-700 transition font-medium text-sm">
                                        <ion-icon name="eye-outline"></ion-icon>
                                        <span>Preview Online</span>
                                    </a>
                            ...
                            <div class="border border-gray-200 rounded-xl p-4 md:p-5 hover:shadow-md transition">
                                ...
                                <div class="space-y-2">
                                    <a href="https://docs.google.com/presentation/d/1JKL012/edit?usp=sharing" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-orange-600 text-white px-3 py-2 rounded-lg hover:bg-orange-700 transition font-medium text-sm">
                                        <ion-icon name="download-outline"></ion-icon>
                                        <span>Download PPTX</span>
                                    </a>
                                    <a href="https://docs.google.com/presentation/d/1JKL012/template/preview" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-gray-600 text-white px-3 py-2 rounded-lg hover:bg-gray-700 transition font-medium text-sm">
                                        <ion-icon name="eye-outline"></ion-icon>
                                        <span>Preview Online</span>
                                    </a>
                            ...
                            <div class="border border-gray-200 rounded-xl p-4 md:p-5 hover:shadow-md transition">
                                ...
                                <div class="space-y-2">
                                    <a href="https://docs.google.com/document/d/1MNO345/edit?usp=sharing" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-red-600 text-white px-3 py-2 rounded-lg hover:bg-red-700 transition font-medium text-sm">
                                        <ion-icon name="download-outline"></ion-icon>
                                        <span>Download DOCX</span>
                                    </a>
                                    <a href="https://docs.google.com/document/d/1MNO345/template/preview" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-gray-600 text-white px-3 py-2 rounded-lg hover:bg-gray-700 transition font-medium text-sm">
                                        <ion-icon name="eye-outline"></ion-icon>
                                        <span>Preview Online</span>
                                    </a>
                            ...
                            <div class="border border-gray-200 rounded-xl p-4 md:p-5 hover:shadow-md transition">
                                ...
                                <div class="space-y-2">
                                    <a href="https://github.com/kampus-riset/templates" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-indigo-600 text-white px-3 py-2 rounded-lg hover:bg-indigo-700 transition font-medium text-sm">
                                        <ion-icon name="logo-github"></ion-icon>
                                        <span>Download dari GitHub</span>
                                    </a>
                                    <a href="https://colab.research.google.com/github/kampus-riset/templates" target="_blank" 
                                       class="w-full inline-flex items-center justify-center space-x-2 bg-gray-600 text-white px-3 py-2 rounded-lg hover:bg-gray-700 transition font-medium text-sm">
                        ...
                        <!-- Tips Section -->
                        <div class="mt-8 bg-blue-50 rounded-xl p-4 md:p-6 border border-blue-200">
